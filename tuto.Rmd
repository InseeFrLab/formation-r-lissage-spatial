...
Le code de cette présentation est disponible ici : <span style="background-color: #FFFF00">(lien vers le gitlab)</span>.
...
A partir de cette source, nous avons constitué nous avons constitué une base de données qui s'intéresse uniquement au périmètre de la **petite couronne parisienne** (départements 75, 92, 93 et 94) et au **millésime 2021**.
...
## Chargement des données cartographique
...
<span style="background-color: #FFFF00">@Julien Faire un petit paragraphe ici sur les avantages d'un lissage par quantile ? Je reste un peu sur ma faim puisque je n'ai pas encore assisté à ta formation théorique ! :)</span>
...
Dans cette section nous allons produire, à partir des données carroyées à 200 mètres disponibles sur [insee.fr](https://www.insee.fr/fr/statistiques/4176290?sommaire=4176305)), un tableau d'indicateurs sur une zone à façon.
