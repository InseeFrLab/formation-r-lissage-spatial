...
## Objectifs du TP {background-color="powderblue"}
...
## Avertissements {background-color="powderblue"}
...
# Configurations {background-color="black"}

------------------------------------------------------------------------

## Chargement des librairies {background-color="powderblue"}
...
## Chargement de la base {background-color="powderblue"}
...
## Chargement et préparation des données cartographiques {background-color="powderblue"}
...
## Carroyage de données {background-color="powderblue"}
...
3.  Passer d'une table de centroïdes à une table de carreaux vectoriels 
...
# Lissage {background-color="black"}

------------------------------------------------------------------------

## Calcul de densité {background-color="powderblue"}
...
## Calcul de moyenne {background-color="powderblue"}
...
## Calcul de taux {background-color="powderblue"}
...
# Indicateurs sur zonage à façon {background-color="black"}
...
## Données ponctuelles {background-color="powderblue"}
