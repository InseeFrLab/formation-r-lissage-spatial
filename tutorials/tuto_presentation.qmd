...
On peut alors filtrer (via les x,y) les logements du rectangle jaune
...
:arrow_right:  On lissera ensuite la variable `nbObsLisse` avec la fonction `btb_smooth`
...
### Partir de données ponctuelles ou déjà carroyées
