...
packages <-  c("dplyr","sf","mapsf","mapview","aws.s3")
...
# Utilisation de BTB v 0.2.0
devtools::install_github("jpramil/btb")
library(btb)
...
Pour information, les variables `x_centro` et `y_centro` correspondant respectivement aux variables `x` et `y` auxquelles : 
