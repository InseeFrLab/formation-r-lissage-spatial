...
Le code ayant permis de constituer la base de données est disponible en suivant ce [lien](https://github.com/InseeFrLab/formation-r-lissage-spatial/blob/main/tutorials/prepa_data.R).
...
Pour utiliser `btb`avec **Qgis**, un tutoriel est disponible sous AUS à l'adresse suivante : "V:/PSAR-AU/Formation Comment utiliser les outils AU/2019/Séquence 6 - Outils/Formation_AU_Sequence_6_TP_partie_1.odt". Ce tutoriel n'a pas été intégré au programme de cette formation afin de privilégier la mise en applcition sous R.
