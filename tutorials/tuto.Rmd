...
Ici, nous allons sélectionner les ventes immobilières appartenant à un grand rectangle englobant Paris intramuros. L'idée est de pouvoir réduire la quantité de ventes à considérer avant le lissage, uniquement en filtrant les coordonnées x et y comprises dans le rectangle. Il s'agit ici d'un simple filtre numérique, et non d'une opération géométrique (voir *infra*). Ainsi, cette méthode est très efficace en termes computationnels, même s'ils faut construire un rectangle adapté au préalable.
