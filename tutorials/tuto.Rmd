...
Nous allons utiliser le SSPCloud, afin que chacun puisse utiliser le même environnement de développement.

Pour cela, voici les étapes : 

  * Aller sur la plateforme SSPCloud en suivant ce lien.
