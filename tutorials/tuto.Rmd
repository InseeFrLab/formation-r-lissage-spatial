...
object <- "r-lissage-spatial/depCouronne.gpkg"
...
```{r triangleOr}
object <- "r-lissage-spatial/triangle_or.kml"
...
object = "r-lissage-spatial/carreaux_idf.RDS"
download.file(paste0(url_bucket,bucket,"/",object), destfile = "carreaux_idf.RDS")
carreaux <- readRDS("carreaux_idf.RDS")
```
