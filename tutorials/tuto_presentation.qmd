...
::::: {.textmini2}
:arrow_right: Périphérie de Paris : densités artificiellement plus faibles
::::: 
...
## 3.4 Calcul de quantiles géographiquement pondérés {background-color="powderblue"}
...
<!-- éléments sur zonage à façon masqué pour gain sur la CI et focus lissage -->
<!-- ça peut s'jouter à l'occasion, à voir si le support est utile -->
...
<!-- t_crs(triangleOr)$epsg ; st_crs(sfBase)$epsg -->
...
<!-- Objectif : obtenir la proportion de logements sociaux dans un rayon de 1 km autour de la Direction générale de l'Insee. -->
...
<!-- 1.  Chargement des données carroyées de Filosofi à 200m, uniquement en région parisienne, en ne conservant qu'un nombre réduit de variables, dont le nombre de logements sociaux. -->
...
# Conclusion {background-color="skyblue"}
