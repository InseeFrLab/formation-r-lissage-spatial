...
packages <-  c("devtools","dplyr","sf","mapsf","leaflet","mapview")
...
# Installation de BTB v2 (sur github)
...
points_carroyage <- btb::btb_add_centroids(pts = dfBase_filtre,iCellSize = iCellSize) 
...
```{r carroyage3}
carreaux <- btb::btb_ptsToGrid(pts = points_carroyage, sEPSG = 2154, iCellSize = iCellSize)
```
