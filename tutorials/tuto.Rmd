...
date: "Dernière mise à jour : mars 2024"
output: 
  rmdformats::robobook:
    highlight: kate
...
Schéma, aperçu de la zone, du buffer et de 2000 points tirés aléatoirement dedans :
...
mf_base(paris_sf, col = "blue", add = T)
mf_base(sfBase_sample$geometry, col = "green", add = T)
```
