...
# Introduction {background-image="images/slide_titres.png"}

------------------------------------------------------------------------

## Objectifs du TP {background-color="aquamarine"}
...
## Avertissements {background-color="aquamarine"}
...
# Configurations {background-image="images/slide_titres.png"}

------------------------------------------------------------------------

## Chargement des librairies{background-color="aquamarine"}
...
## Chargement de la base {background-color="aquamarine"}
...
## Chargement des données cartographiques{background-color="aquamarine"}
...
# Lissage {background-image="images/slide_titres.png"}

------------------------------------------------------------------------

## Calcul de densité{background-color="aquamarine"}
...
## Calcul de moyenne{background-color="aquamarine"}
...
## Calcul de taux{background-color="aquamarine"}
...
## Calcul de quantiles géographiquement pondérés{background-color="aquamarine"}
...
# Indicateurs sur zonage à façon {background-image="images/slide_titres.png"}
...
## Données ponctuelles{background-color="aquamarine"}
...
## Données carroyées{background-color="aquamarine"}
