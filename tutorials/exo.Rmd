...
- `parkings.RDS` : table de données géolocalisées concernant les parkings publics dans l'agglomération bordelaise. Attention : on parle de parking publics et non de places de stationnements ! Pour chaque parking public, voici les variables renseignées : 
...
Lisser le taux de place de stationnement pour personnes à mobilité réduite (en %).
