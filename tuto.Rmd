...
dfBase <- 
  aws.s3::s3read_using(
    FUN = base::readRDS,
    object = "diffusion/ventesImmo_couronneParis.RDS",
    bucket = "jpramil"
    ,
    opts = list("region" = "")
  )
...
depCouronne_sf <- 
  aws.s3::s3read_using(
    FUN = sf::st_read,
    object = "diffusion/depCouronne.gpkg",
    bucket = "jpramil"
    ,
    opts = list("region" = "")
  )
...
triangleOr <- 
  aws.s3::s3read_using(
    FUN = st_read,
    object = "diffusion/triangle_or.kml",
    bucket = "jpramil"
    ,
    opts = list("region" = "")
  )
...
carreaux <- 
  aws.s3::s3read_using(
    FUN = st_read_maison,
    object = "diffusion/Filosofi2015_carreaux_200m_metropole.gpkg",
    bucket = "jpramil"
    ,
    opts = list("region" = "")
  )
